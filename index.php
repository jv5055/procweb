...
<body class="flex-column">
    <nav class="navbar navbar-expand-md sticky-top py-3 navbar-dark" id="mainNav-1">
        <div class="container"><a class="navbar-brand d-flex justify-content-center align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
                    ...
                    </svg></span><span>JV5055</span></a></div>
    </nav>
    <section class="py-5">
        <div class="container flex-grow-1" style="height: 556px;">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Ruokalista</p>
                    <h2 class="fw-bold">Tänään tarjolla:</h2>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="container text-md-left">
                <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                    <p class="mb-0">Copyright © 2025 JV5055</p>
